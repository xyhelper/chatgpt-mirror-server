  ...
  !(function () {
    ...
    var Y = function (e, t) {
        if (e[R]) e[R][t] || (e[R][t] = {});
          ...
          var n = t ? Q({}, t, {}) : {};
          Object.defineProperty(e, R, { value: n, writable: !0 });
        }
      },
      ee = function (e, t, n, r) {
    ...
    var ce = "sampled",
      se = "error",
      ue = { onReady: 3e4, onShown: 6e4 },
      le = {
        enabled: { type: "boolean", default: !1 },
        onReadyThreshold: { type: "integer", default: ue.onReady },
        onShownThreshold: { type: "integer", default: ue.onShown },
              ...
              try {
                ...
                if (a && i === t.config.publicKey)
                  return (
                    t.emitter.emit(a, s),
                    "broadcast" === c &&
                      t.postMessageToParent({ data: s, key: i, message: a }),
                    void (
                      "emit" === c &&
                      t.postMessageToChildren({ data: s, key: i, message: a })
                    )
                  );
                n &&
    ...
    var Je = {
      ...
      Ye = function () {
        return pe()(
          Xe.container,
          Ze({ show: !!Je.show, active: !!Je.isActive }, Je.mode, !0)
        );
      };
      ...
      if (Je.frame) {
        ...
        if (Je.ECResponsive) {
          var f = (function (e) {
            ...
            return (s = Z(s)), { height: (u = Z(u)), width: s };
          })({
            width: t,
            height: n,
            minWidth: r,
        ...
        return {
          ...
          timerStart: function (e) {
            ...
            if (!n.start) {
              ...
              O("".concat(e, " started:"), t),
                (s[e] = E(oe(oe({}, n), {}, { start: t, threshold: r })));
            }
          },
          timerEnd: function (e) {
            var t =
          ...
          logWindowError: function (e, t, n, r) {
            (y && !0 !== y.windowErrorEnabled) ||
              (u[e] = { message: t, filename: n, stack: r });
          },
          debugLog: O,
    ...
    var dt = function (e) {
      ...
      Lt = function () {
        vt.enforcementReady &&
          ...
          vt.isHidden &&
            ((vt.isHidden = !1),
            vt.isReady && Pe.emit(x, { token: vt.token })));
      },
      It = function () {
        var e = (
          arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}
      ...
      Dt = function (e) {
        return 27 !== B(e, "keyCode") ? null : It({ manual: !0 });
      },
      Ft = function () {
    ...
    Pe.on(w, function () {
      ...
      Pe.on(S, function (e) {
        (vt.enforcementLoaded = !0), Ht(e || vt.config), qt({ event: S });
      }),
      ...
      Pe.on(k, function (e) {
        ...
        pt.setup(a, vt.config.mode), qt({ event: n, observability: i }), Tt();
      }),
